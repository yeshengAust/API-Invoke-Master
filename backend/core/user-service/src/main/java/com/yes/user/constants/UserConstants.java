...
public class UserConstants
{
     ...
     * 缓存时间单位
     */
    public static final TimeUnit USER_INFO_EXPIRE_UNIT=TimeUnit.HOURS;
    /**
     * 用户登录缓存
     */
    public static final String USER_LOGIN_CACHE="cache:user:login:";

    /**
     * 获取用户登录锁
     */
    public static final String USER_LOGIN_LOCK="lock:user:login:";
