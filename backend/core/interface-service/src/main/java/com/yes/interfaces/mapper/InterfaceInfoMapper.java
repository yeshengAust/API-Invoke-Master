...
public interface InterfaceInfoMapper extends BaseMapper<InterfaceInfo> {
    ...
    List<Long> getHotInterfaces();

    InterfaceExampleVo getInterfaceExample(Long interfaceId);

    @MapKey("id")
    List<Map<String, Object>> getAllInterfaceInvokeCount();

    void updateInvokeCountBatch(@Param("invokeCountMap")Map<Long, Long> invokeCountMap);
}
